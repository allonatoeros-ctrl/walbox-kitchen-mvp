# RUN CONTEXT — Walbox UI audit read-only: verifica visivamente lo stato del nuovo badge Sync TV in StaffDashboard.jsx. Obiettivo: controllare se è leggibile, non rompe layout header e comunica bene OK/interrotta/assente. Non cambiare file.

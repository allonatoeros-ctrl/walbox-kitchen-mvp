# AI FACTORY RUN LOG — AI Factory audit read-only: progettare Context Pack Lite V0. Verifica come viene generato oggi context.md, quali dati minimi può includere senza RAG, e proponi il micro-step implementativo. Non modificare file.

## 1. Raw task

AI Factory audit read-only: progettare Context Pack Lite V0. Verifica come viene generato oggi context.md, quali dati minimi può includere senza RAG, e proponi il micro-step implementativo. Non modificare file.
...
- git status --short
- nessuna modifica a ai-ops/runner/

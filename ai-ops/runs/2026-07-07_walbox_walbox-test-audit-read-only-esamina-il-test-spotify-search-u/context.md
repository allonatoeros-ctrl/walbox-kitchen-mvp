# RUN CONTEXT — Walbox test audit read-only: esamina il test spotify-search-ui.spec.js e il bottone RICONTROLLA. Obiettivo: capire perché 2 test non passano e proporre un controllo minimo. Non cambiare file.

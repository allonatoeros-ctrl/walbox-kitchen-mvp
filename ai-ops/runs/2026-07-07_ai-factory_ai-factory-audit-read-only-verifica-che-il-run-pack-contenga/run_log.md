# AI FACTORY RUN LOG — AI Factory audit read-only: verifica che il Run Pack contenga runner.json, claude_prompt.md, context.md, run_log.md e result.md. Non modificare file.

## 1. Raw task

AI Factory audit read-only: verifica che il Run Pack contenga runner.json, claude_prompt.md, context.md, run_log.md e result.md. Non modificare file.

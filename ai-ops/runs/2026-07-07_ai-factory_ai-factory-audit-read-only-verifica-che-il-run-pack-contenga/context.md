# RUN CONTEXT — AI Factory audit read-only: verifica che il Run Pack contenga runner.json, claude_prompt.md, context.md, run_log.md e result.md. Non modificare file.

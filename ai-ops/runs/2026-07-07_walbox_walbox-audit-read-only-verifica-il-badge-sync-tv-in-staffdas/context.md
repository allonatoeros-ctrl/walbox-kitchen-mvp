# RUN CONTEXT — Walbox audit read-only: verifica il badge Sync TV in StaffDashboard usando i Known files del context.md come punto di partenza. Obiettivo: controllare se context.md aiuta a localizzare il file corretto. Non modificare file.

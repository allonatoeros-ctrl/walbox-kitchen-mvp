# AI FACTORY RUN LOG — Walbox audit read-only: verifica il badge Sync TV in StaffDashboard usando i Known files del context.md come punto di partenza. Obiettivo: controllare se context.md aiuta a localizzare il file corretto. Non modificare file.

## 1. Raw task

Walbox audit read-only: verifica il badge Sync TV in StaffDashboard usando i Known files del context.md come punto di partenza. Obiettivo: controllare se context.md aiuta a localizzare il file corretto. Non modificare file.
...
- Matched keywords: qa: verifica, sync · design: tv · tv: tv
- Risk level: medium
- categoria "qa" → medium
